...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/idolum-ai/idolum-worker/tree/idolum)
...
4. Select the `openclaw-sandbox-data` bucket (created automatically on first deploy)
