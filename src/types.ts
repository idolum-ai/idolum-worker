...
export interface OpenClawEnv {
  ...
  OPENCLAW_GATEWAY_TOKEN?: string; // Gateway token (mapped to CLAWDBOT_GATEWAY_TOKEN for container)
  ...
  SANDBOX_SLEEP_AFTER: string; // Required: How long before sandbox sleeps, e.g., '10m', '1h'
